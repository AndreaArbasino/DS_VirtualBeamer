...
public class DeprecatedConnection implements Runnable{
    ...
    public void run(){
        ...
        try {
            ...
            System.out.println("port: " + multicastSocket.getPort());
            //multicastSocket.setNetworkInterface(StaticUtilities.getLocalNetworkInterface());
        ...
        System.out.println("inet address: " + multicastSocket.getInetAddress());
        System.out.println("Is local address? " + multicastSocket.getLocalAddress().isAnyLocalAddress());
        System.out.println("local address: " + multicastSocket.getLocalAddress());
        System.out.println("port: " + multicastSocket.getPort());

        try {
            System.out.println("Network interface: " + multicastSocket.getNetworkInterface());
        } catch (SocketException e) {
            throw new RuntimeException(e);
        }
        System.out.println("Local socket address" + multicastSocket.getLocalSocketAddress());
